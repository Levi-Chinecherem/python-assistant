...
def wish_user():
    ...
    if hour >= 0 and hour < 12:
        fun_talk("Good Morning !" + user_name)
    elif hour >= 12 and hour < 18:
        fun_talk("Good Afternoon !" + user_name)
    else:
        fun_talk("Good Evening !" + user_name)
        
    fun_talk("I am P.A. (Python Assistant). Tell me how may I help you.")

    print("I'm ready, what can i do for you?...")
...
def get_command():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            print("Google Speech Recognition could not understand audio")
            fun_talk("Speech not recognized. Please try again.")
            return "None"
        except sr.RequestError as e:
            print("Could not request results from Google Speech Recognition service; {0}".format(e))
            fun_talk("Speech recognition service is unavailable. Please check your internet connection.")
            return "None"
        except Exception as e:
            print(e)
            print("Say that again please...")
...
if __name__ == '__main__':
    ...
    while True: 
        ...
        elif any(keyword in query for keyword in ['images', 'image']):
          ...
          record.screen_record()
            ...
            try:
                ...
                pass
                    ...
                    fun_talk('Error getting response.')
